...
@Getter
public class DeleteItemResponseDto extends ResponseDto {

	public DeleteItemResponseDto() {
		super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
	}

	public static ResponseEntity<DeleteItemResponseDto> success() {
		DeleteItemResponseDto result = new DeleteItemResponseDto();
